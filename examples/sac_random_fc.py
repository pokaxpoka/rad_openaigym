...
from rlkit.data_management.env_replay_buffer import RandomEnvReplayBuffer
...
def parse_args():
    ...
    # randomization
    parser.add_argument('--single_flag', default=0, type=int)
    parser.add_argument('--equal_flag', default=0, type=int)
    parser.add_argument('--lower', default=0.5, type=float)
    parser.add_argument('--upper', default=1.5, type=float)
...
def experiment(variant):
    ...
    replay_buffer = RandomEnvReplayBuffer(
...
if __name__ == "__main__":
    ...
    set_seed(args.seed)
    exp_name = 'random_dim_' + str(args.single_flag) + '_equal_' + str(args.equal_flag)
    exp_name += '_uni_' + str(args.lower) + '_' + str(args.upper)
