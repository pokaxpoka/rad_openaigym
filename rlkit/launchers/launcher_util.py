...
def custom_create_exp_name(
    ...
    :return:
    """
    return "%s_batch_%d_layer_%d_seed_%d" % (exp_prefix, batch, num_layer, seed)

def custom_create_log_dir(
        exp_prefix,
        env_name,
        batch=256,
        num_layer=2,
    ...
    :return:
    """
    exp_name = custom_create_exp_name(
